...
urlpatterns = [
    ...
    path("assignment/subject_id=<int:subject_id>", IndexView.as_view(), name="assignment-subject"),
    path("assignment/topic_id=<int:topic_id>", IndexView.as_view(), name="assignment-topic"),
